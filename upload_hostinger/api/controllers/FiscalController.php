...
class FiscalController extends ApiController {
    ...
    public function emitirAvulsa() {
        ...
        try {
            ...
            $stmt = $this->db->prepare("INSERT INTO fiscal_notes (id, company_id, sale_id, tipo, numero, serie, status, xml_path) 
                                        VALUES (:id, :company_id, :sale_id, :tipo, :numero, :serie, 'generated', :xml)");
            $noteId = generateUUID();
    ...
    public function emitirNFe() {
        ...
        try {
            ...
            $stmt = $this->db->prepare("INSERT INTO fiscal_notes (id, company_id, sale_id, tipo, numero, serie, status, xml_path) 
                                        VALUES (:id, :company_id, :sale_id, :tipo, :numero, :serie, 'generated', :xml)");
            $noteId = generateUUID(); // UUID padrão
